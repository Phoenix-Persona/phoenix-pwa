...
Engineering reference for agents working on Phoenix. **Start with
...
| [`PERSONA-SCHEMA.md`](./PERSONA-SCHEMA.md) | The three Nostr events Phoenix publishes per persona (kind 0, kind 30078, kind 1). Mirrors `PROJECT.md` §5. |
| [`THREAT-MODEL.md`](./THREAT-MODEL.md) | What Phoenix protects, what it doesn't, where secrets live. Mirrors `PROJECT.md` §3. |
...
External libraries and protocols Phoenix depends on. Each guide has a
"Source" footer pointing at upstream — fall back to that when in doubt.

| Doc | What it covers |
| --- | --- |
| [`guides/nostr-nips.md`](./guides/nostr-nips.md) | NIPs Phoenix uses: 01, 44, 49, 57, 78, 92, 94. Plus event-kind cheat sheet. |
...
| [`guides/breeze-sdk.md`](./guides/breeze-sdk.md) | `@breeztech/breez-sdk-liquid` — per-persona Lightning wallet. Forward-looking; integration pending. |
